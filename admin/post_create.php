...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_FILES['thumbnail']) && $_FILES['thumbnail']['error'] === UPLOAD_ERR_OK) {
        if (isValidImageFile($_FILES['thumbnail'])) {
            $thumbnailName = uploadImage($_FILES['thumbnail'], '../uploads/');
            if (!$thumbnailName) {
    ...
    <div class="admin-wrapper">
        ...
        <main class="main-content">
            <div class="content-header">
                <h1 class="page-title">Buat Post Baru</h1>
                            ...
                            <div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="excerpt" 
                                              ...
                                              class="form-control" 
                                              rows="3"
                                              maxlength="300"><?php echo htmlspecialchars($formData['excerpt'] ?? ''); ?></textarea>
                            ...
                            <div>
                                <div class="form-group">
                                    ...
                                    <select id="status" name="status" class="form-control" required>
                                        ...
                                        <option value="published" <?php echo ($formData['status'] ?? '') === 'published' ? 'selected' : ''; ?>>Publish</option>
                                    </select>
                                </div>
